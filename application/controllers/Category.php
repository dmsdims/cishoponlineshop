...
// berfungsi untuk menampilakan data dalam kategori seperti pagination ,rows dan content
	public function index($page = null)
	{
		...
		$data['pagination']	= $this->category->makePagination(
			// kalau ingin memberikan urutan ke 2 harus menambakan perintah $route['category/(:num)'] = 'category/index/$1'; 
			//  pada file config/routers 
...
// untuk membuat fungsi pencarian data
...
// fungsi tambah kategori
	...
	{
		// funsi inputan validasi yang memalalui metode post pada form yang kita isi
		if (!$_POST) {
			$input	= (object) $this->category->getDefaultValues();
		} else {
			$input	= (object) $this->input->post(null, true);
		}
//  apakah berhasil melakukan validasi //class validasi ada diMY_Model 
...
// jika validasi kategori berhasil akan succes disimpan 
...
// fungsi edit kategori
	...
	public function unique_slug()
	{
		...
		// jika terdapat suatu nilai didalam suatu kategori maka akan ada pesan error
		if ($category) {
			if ($id == $category->id) {
				return true;
			}
